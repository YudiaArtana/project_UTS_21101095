        ...
        <div class="card border-0 p-3 shadow">
            <div class="card-header border-0">
                <div class="row align-items-center py-4">
                    <div class="col">
                        <h3 class="mt-1 fw-bold">List Data Dokter</h3>
                    </div>
                    <div class="col d-flex flex-row-reverse">
                        <a href='dokter_insertdata.php'><input class="btn btn-success py-3 px-5 fw-bold rounded-pill" type="button" value="Tambah Data"></a>
                    </div>
                </div>
                <ul class="nav nav-tabs fw-bold">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link-primary active" href="dokter_viewdata.php">Dokter</a>
                    </li>
                    <li class="nav-item">
